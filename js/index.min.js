! function () {
    var e = {
                    ...
                    for (var a = {}, i = [], r = 0; r < e.length; r++) {
                        ...
                        var c = n(p),
                            u = {
                                ...
                                media: o[2],
                                sourceMap: o[3]
                            }; - 1 !== c ? (s[c].references++, s[c].updater(u)) : s.push({
                            identifier: p,
                            updater: v(u, t),
                            references: 1
                        }), i.push(p)
            ...
            164: function (e) {
                e.exports = e => (e = (e = (e = e.replace(/<[^>]+>/gim, "")).replace(/\[(.*?)\]\((.*?)\)/gm, "[链接]")).replace(/\bhttps?:\/\/(?!\S+(?:jpe?g|png|bmp|gif|webp|gif|mp4))\S+/g, "[链接]")).replace(/!\[(.*?)\]\((.*?)\)/gm, "[图片]")
            },
            833: function (e) {
                const {
                    limit: t,
                ...
                e.exports = async function () {
                    let e = a,
                        r = 10;
                    t && (r = t), e = `${e}/api/ispeak?author=${i}&page=1&pageSize=${r}`;
                    const s = window.localStorage.getItem("ispeak-token"),
                        n = {};
            ...
            957: function (e) {
                e.exports = function () {
                        ...
                        if (!t.animating || !n.preventInteractionOnTransition) {
                            ...
                            if (("wrapper" !== n.touchEventsTarget || p.closest(t.wrapperEl).length) && (r.isTouchEvent = "touchstart" === d.type, (r.isTouchEvent || !("which" in d) || 3 !== d.which) && !(!r.isTouchEvent && "button" in d && d.button > 0 || r.isTouched && r.isMoved)))
                                ...
                                if (S(r, {
                                        ...
                                        isScrolling: void 0,
                                        startMoving: void 0
                                    }), l.startX = c, l.startY = u, r.touchStartTime = E(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, n.threshold > 0 && (r.allowThresholdMove = !1), "touchstart" !== d.type) {
                                    var v = !0;
                    ...
                    function B(e) {
                        ...
                        if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), u < 300 && c - a.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), a.lastClickTime = E(), x((function () {
                        ...
                        if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, p = i.followFinger ? s ? t.translate : -t.translate : -a.currentTranslate, !i.cssMode)
                            if (i.freeMode) {
                                ...
                                if (i.freeModeMomentum) {
                                    ...
                                    i.freeModeMomentumBounce && C ? (t.updateProgress(y), t.setTransition(g), t.setTranslate(b), t.transitionStart(!0, t.swipeDirection), t.animating = !0, n.transitionEnd((function () {
                                ...
                                if (u > i.longSwipesMs) {
                                    ...
                                    "next" === t.swipeDirection && (O >= i.longSwipesRatio ? t.slideTo(P + B) : t.slideTo(P)), "prev" === t.swipeDirection && (O > 1 - i.longSwipesRatio ? t.slideTo(P + B) : t.slideTo(P))
                                } else {
                                    if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
                                    !t.navigation || d.target !== t.navigation.nextEl && d.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(P + B), "prev" === t.swipeDirection && t.slideTo(P)) : d.target === t.navigation.nextEl ? t.slideTo(P + B) : t.slideTo(P)
                                }
                            }
                    }
                    ...
                    var X = {
                        ...
                        R = {
                            ...
                            update: {
                                ...
                                updateSlides: function () {
                                    ...
                                    if (void 0 !== s) {
                                        var T, C;
                                        "string" == typeof b && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * s), e.virtualSize = -b, n ? p.css({
                                            marginLeft: "",
                                            marginTop: ""
                                        }) : p.css({
                                            marginRight: "",
                                        ...
                                        for (var A, M, z, k = i.slidesPerColumn, P = T / k, L = Math.floor(c / i.slidesPerColumn), $ = 0; $ < c; $ += 1) {
                                            ...
                                            if (i.slidesPerColumn > 1) {
                                                ...
                                                if ("row" === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
                                                    ...
                                                    O = (B = N - (D = Math.floor(N / Y)) * Y + G * i.slidesPerGroup) + D * T / k, I.css({
                                        ...
                                        if (e.virtualSize = Math.max(e.virtualSize, s) + m, n && o && ("slide" === i.effect || "coverflow" === i.effect) && r.css({
                                                width: e.virtualSize + i.spaceBetween + "px"
                                            }), i.setWrapperSize && r.css(((M = {})[t("width")] = e.virtualSize + i.spaceBetween + "px", M)), i.slidesPerColumn > 1 && (e.virtualSize = (C + i.spaceBetween) * T, e.virtualSize = Math.ceil(e.virtualSize / i.slidesPerColumn) - i.spaceBetween, r.css(((z = {})[t("width")] = e.virtualSize + i.spaceBetween + "px", z)), i.centeredSlides)) {
                                            A = [];
                                ...
                                updateProgress: function (e) {
                                    ...
                                    var i = t.params,
                                        ...
                                        l = n,
                                        d = o;
                                    0 === r ? (s = 0, n = !0, o = !0) : (n = (s = (e - t.minTranslate()) / r) <= 0, o = s >= 1), S(t, {
                                        progress: s,
                                        isBeginning: n,
                                        isEnd: o
                                    }), (i.watchSlidesProgress || i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) && t.updateSlidesProgress(e), n && !l && t.emit("reachBeginning toEdge"), o && !d && t.emit("reachEnd toEdge"), (l && !n || d && !o) && t.emit("fromEdge"), t.emit("progress", s)
                                },
                            ...
                            translate: {
                                ...
                                translateTo: function (e, t, a, i, r) {
                                    ...
                                    var l, d = s.minTranslate(),
                                        p = s.maxTranslate();
                                    if (l = i && e > d ? d : i && e < p ? p : e, s.updateProgress(l), n.cssMode) {
                            ...
                            slide: {
                                slideTo: function (e, t, a, i) {
                                    ...
                                    return 0 === t ? (s.setTransition(0), s.setTranslate(g), s.updateActiveIndex(n), s.updateSlidesClasses(), s.emit("beforeTransitionStart", t, i), s.transitionStart(a, m), s.transitionEnd(a, m)) : (s.setTransition(t), s.setTranslate(g), s.updateActiveIndex(n), s.updateSlidesClasses(), s.emit("beforeTransitionStart", t, i), s.transitionStart(a, m), s.animating || (s.animating = !0, s.onSlideToWrapperTransitionEnd || (s.onSlideToWrapperTransitionEnd = function (e) {
                                        s && !s.destroyed && e.target === this && (s.$wrapperEl[0].removeEventListener("transitionend", s.onSlideToWrapperTransitionEnd), s.$wrapperEl[0].removeEventListener("webkitTransitionEnd", s.onSlideToWrapperTransitionEnd), s.onSlideToWrapperTransitionEnd = null, delete s.onSlideToWrapperTransitionEnd, s.transitionEnd(a, m))
                                ...
                                slideToClickedSlide: function () {
                                    ...
                                    if (a.loop) {
                                        ...
                                        e = parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10), a.centeredSlides ? s < t.loopedSlides - r / 2 || s > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(), s = i.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), x((function () {
                                            t.slideTo(s)
                                        }))) : t.slideTo(s) : s > t.slides.length - r ? (t.loopFix(), s = i.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), x((function () {
                                            t.slideTo(s)
                                        }))) : t.slideTo(s)
                                    } else t.slideTo(s)
                                }
                                ...
                                attachEvents: function () {
                                    ...
                                    if (!l.touch && l.pointerEvents) r.addEventListener(i.start, e.onTouchStart, !1), t.addEventListener(i.move, e.onTouchMove, d), t.addEventListener(i.end, e.onTouchEnd, !1);
                                        ...
                                        if (l.touch) {
                                            ...
                                            r.addEventListener(i.start, e.onTouchStart, p), r.addEventListener(i.move, e.onTouchMove, l.passiveListener ? {
                                                passive: !1,
                                                capture: d
                                            } : d), r.addEventListener(i.end, e.onTouchEnd, p), i.cancel && r.addEventListener(i.cancel, e.onTouchEnd, p), Y || (t.addEventListener("touchstart", H), Y = !0)
                                ...
                                setBreakpoint: function () {
                                    ...
                                    if (o && (!o || 0 !== Object.keys(o).length)) {
                                        ...
                                        if (l && e.currentBreakpoint !== l) {
                                            ...
                                            }), e.currentBreakpoint = l, e.emit("_beforeBreakpoint", p), f && a && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - r + e.loopedSlides, 0, !1)), e.emit("breakpoint", p)
                                        }
                                    }
                                },
                        ...
                        V = function () {
                            function t() {
                                ...
                                var o = this;
                                o.__swiper__ = !0, o.support = M(), o.device = z({
                                ...
                                var l, d, p = S({}, X);
                                return o.useParams(p), o.params = S({}, p, F, a), o.originalParams = S({}, o.params), o.passedParams = S({}, a), o.params && o.params.on && Object.keys(o.params.on).forEach((function (e) {
                            ...
                            return r.emitContainerClasses = function () {
                                ...
                                var e = this,
                                    ...
                                    n = 1;
                                if (t.centeredSlides) {
                                    for (var o, l = a[s].swiperSlideSize, d = s + 1; d < a.length; d += 1) a[d] && !o && (n += 1, (l += a[d].swiperSlideSize) > r && (o = !0));
                                    for (var p = s - 1; p >= 0; p -= 1) a[p] && !o && (n += 1, (l += a[p].swiperSlideSize) > r && (o = !0))
                                } else
                    ...
                    var W = {
                            update: function (e) {
                                ...
                                if (S(t.virtual, {
                                    ...
                                    }), p === y && c === x && !e) return t.slidesGrid !== h && E !== v && t.slides.css(m, E + "px"), void t.updateProgress();
                                    ...
                                    if (!c) {
                                        ...
                                        if (u >= a.minTranslate() && (u = a.minTranslate()), u <= a.maxTranslate() && (u = a.maxTranslate()), a.setTransition(0), a.setTranslate(u), a.updateProgress(), a.updateActiveIndex(), a.updateSlidesClasses(), (!h && a.isBeginning || !f && a.isEnd) && a.updateSlidesClasses(), a.params.freeModeSticky) {
                                            ...
                                            if (v.push(d), g && (d.delta > g.delta || d.direction !== g.direction)) v.splice(0);
                                                ...
                                                var b = s > 0 ? .8 : .2;
                                                a.mousewheel.lastEventBeforeSnap = d, v.splice(0), a.mousewheel.timeout = x((function () {
                        ...
                        K = {
                            setTranslate: function () {
                                ...
                                if (e.params.scrollbar.el && e.scrollbar.el) {
                                    var t = e.scrollbar,
                                        ...
                                        d = r,
                                        p = (s - r) * i;
                                    a ? (p = -p) > 0 ? (d = r - p, p = 0) : -p + r > s && (d = s + p) : p < 0 ? (d = r + p, p = 0) : p + r > s && (d = s - p), e.isHorizontal() ? (n.transform("translate3d(" + p + "px, 0, 0)"), n[0].style.width = d + "px") : (n.transform("translate3d(0px, " + p + "px, 0)"), n[0].style.height = d + "px"), l.hide && (clearTimeout(e.scrollbar.timeout), o[0].style.opacity = 1, e.scrollbar.timeout = setTimeout((function () {
                            ...
                            updateSize: function () {
                                ...
                                if (e.params.scrollbar.el && e.scrollbar.el) {
                                    ...
                                    var r, s = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                                        ...
                                        o = n * (s / e.size);
                                    r = "auto" === e.params.scrollbar.dragSize ? s * n : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? a[0].style.width = r + "px" : a[0].style.height = r + "px", i[0].style.display = n >= 1 ? "none" : "", e.params.scrollbar.hide && (i[0].style.opacity = 0), S(t, {
                                        trackSize: s,
                                        divider: n,
                                        moveDivider: o,
                                        dragSize: r
                            ...
                            onDragEnd: function (e) {
                                var t = this,
                                    ...
                                    r = t.$wrapperEl,
                                    s = i.$el;
                                t.scrollbar.isTouched && (t.scrollbar.isTouched = !1, t.params.cssMode && (t.$wrapperEl.css("scroll-snap-type", ""), r.transition("")), a.hide && (clearTimeout(t.scrollbar.dragTimeout), t.scrollbar.dragTimeout = x((function () {
                            ...
                            init: function () {
                                ...
                                if (e.params.scrollbar.el) {
                                    ...
                                    0 === s.length && (s = m('<div class="' + e.params.scrollbar.dragClass + '"></div>'), r.append(s)), S(t, {
                                        $el: r,
                                        el: r[0],
                                        $dragEl: s,
                                        dragEl: s[0]
                        ...
                        J = {
                            ...
                            setTranslate: function () {
                                ...
                                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((function (t) {
                                    ...
                                    var s = t.progress;
                                    e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (s += Math.ceil(a / 2) - i * (r.length - 1)), s = Math.min(Math.max(s, -1), 1), m(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((function (t) {
                            ...
                            onTouchMove: function (e) {
                                ...
                                if (i.$imageEl && 0 !== i.$imageEl.length && (t.allowClick = !1, r.isTouched && i.$slideEl)) {
                                    ...
                                    if (!(n < i.slideWidth && o < i.slideHeight)) {
                                        if (r.minX = Math.min(i.slideWidth / 2 - n / 2, 0), r.maxX = -r.minX, r.minY = Math.min(i.slideHeight / 2 - o / 2, 0), r.maxY = -r.minY, r.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, r.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !r.isMoved && !a.isScaling) {
                            ...
                            load: function () {
                                ...
                                if (n.loadPrevNext)
                                    if (o > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
                                        for (var c = n.loadPrevNextAmount, u = o, h = Math.min(r + u + Math.max(c, u), i.length), f = Math.max(r - Math.max(u, c), 0), v = r + o; v < h; v += 1) l(v) && e.lazy.loadInSlide(v);
                            ...
                            LinearSpline: function (e, t) {
                                ...
                                return this.x = e, this.y = t, this.lastIndex = e.length - 1, this.interpolate = function (e) {
                                    return e ? (n = function (e, t) {
                                        ...
                                        return a
                                    }(this.x, e), s = n - 1, (e - this.x[s]) * (this.y[n] - this.y[s]) / (this.x[n] - this.x[s]) + this.y[s]) : 0
                                }, this
                            },
    ...
    a.n = function (e) {
        ...
        function () {
            ...
            (async () => {
                ...
                try {
                    const e = await t(),
                        s = document.querySelector("#bbTimeList #bber-talk"),
                        n = document.querySelector(".swiper-weapper-aside");
                    console.log(e);
                    for (const t of e.items) {
                        const e = i(t.content);
                        a += `<div class='li-style swiper-slide'>${e}</div>`, r += `<div class='swiper-slide aside-bbtalk'>${e}</div>`
                    }
                    s.innerHTML = a, n.innerHTML = r
                } catch (e) {
                    a += "<div class='li-style swiper-slide'>获取失败</div>", r += "<div class='swiper-slide aside-bbtalk'>获取失败</div>"
                }
                new e("#bbtalk", {
                    direction: "vertical",
                    loop: !0,
